define([],function(){
	...
	var ListServico = function(html_id){
		"use strict";

		var main = this;
		this.html_id = html_id;
		$('.title_sistema').text('Projeto EAD - Servicos');
		...
		this.tbl_servico = this.dialog.find('.tbl_servico');
		...
		this.listar = function(){
			...
			var table_body = main.tbl_servico.find('tbody');
			var template_row = $(table_body).find('[template-row="servico"]');
			...
			var add_row = function(i, item){
				...
				btn_editar.click(function(e){
					Util.load_pag(`servico/detalhes`, function(id, obj){
						obj.show(item.id);
			...
			(
				...
				null, 
				function(response){
					main.tbl_servico.find('.rows').remove();
